# 👥 Ghid Pair Programming — Săptămâna 11
...
## Exerciții Pair Programming — Săptămâna 11


### Exercițiul PP1: Client Load Balancer

**Timp:** 20 minute (2 rotații)

**Obiectiv:** Testați distribuția cererilor la load balancer.

**Cerințe:**
1. Trimiteți 10 cereri către http://localhost:8080
2. Identificați care backend a răspuns la fiecare
3. Verificați dacă distribuția e round-robin

**Driver începe cu:** Bucla de cereri
**Navigator ghidează:** Extragerea informațiilor din răspuns
