# 👥 Ghid Pair Programming — Săptămâna 1
...
## Exerciții Pair Programming — Săptămâna 1


### Exercițiul PP1: Script de diagnoză rețea

**Timp:** 20 minute (2 rotații de roluri)

**Obiectiv:** Creați un script care verifică conectivitatea la 3 servere diferite.

**Cerințe:**
1. Ping către localhost, google.com, și 8.8.8.8
2. Afișează rezultatul fiecărui ping
3. Calculează latența medie

**Driver începe cu:** Import-urile și structura de bază
**Navigator ghidează:** Logica de iterare și afișare
