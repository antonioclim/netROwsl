# 👥 Ghid Pair Programming — Săptămâna 2
...
## Exerciții Pair Programming — Săptămâna 2


### Exercițiul PP1: Server Echo TCP

**Timp:** 25 minute (2-3 rotații)

**Obiectiv:** Implementați un server echo simplu și un client care trimite mesaje.

**Cerințe:**
1. Server: ascultă pe port 9090
2. Client: se conectează și trimite "Hello"
3. Server: răspunde cu aceleași date

**Driver începe cu:** Codul serverului
**Navigator ghidează:** Ordinea operațiilor socket
